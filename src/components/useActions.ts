...
import { FunNameMapType, ActionFunMapRetType, useActionMapper } from './useMappers'

/**
 * @param {*} moduleName 模块名称
 * @param {*} mapper 方法名集合 ['fn1', 'fn2']
 */
function useActions (moduleName: string, mapper: FunNameMapType): ActionFunMapRetType {
